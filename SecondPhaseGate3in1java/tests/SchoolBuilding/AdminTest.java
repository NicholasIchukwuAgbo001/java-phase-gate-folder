...
class AdminTest {
    ...
    public void testAddStudent() {
        Student student1 = new Student("Niko", "07058705863", "C24");
        Student student2 = new Student("John", "09058705863", "C24");
    ...
    public void testAddSameStudentTwice_ThrowException() {
        Student student1 = new Student("John", "09058705863", "C24");
        admin.addStudent(student1);
    ...
    public void testRemoveStudent() {
        Student student1 = new Student("Niko", "07058705863", "C24");
        Student student2 = new Student("John", "09058705863", "C25");
        Student student3 = new Student("Moses", "08058705863", "C26");
        admin.addStudent(student1);
        admin.addStudent(student2);
    ...
    public void testAddFacilitator() {
        Facilitator facilitator1 = new Facilitator("Miss Jenny", "JAVA");
        Facilitator facilitator2 = new Facilitator("Mr Sikiru", "PYTHON");
    ...
    public void testRemoveFacilitator() {
        Facilitator facilitator1 = new Facilitator("Miss Jenny", "JAVA");
        Facilitator facilitator2 = new Facilitator("Mr Sikiru", "PYTHON");
        Facilitator facilitator3 = new Facilitator("Mr Chinedu", "JAVASCRIPT");
        Facilitator facilitator4 = new Facilitator("Mr FM", "JAVA");
        admin.addFacilitator(facilitator1);
        admin.addFacilitator(facilitator2);
